...
var MonthInput = function (_BaseInput) {
  _inherits(MonthInput, _BaseInput);

  function MonthInput(props) {
    _classCallCheck(this, MonthInput);

    var _this = _possibleConstructorReturn(this, (MonthInput.__proto__ || Object.getPrototypeOf(MonthInput)).call(this, props));

    _this.handleSelect = function (e, _ref) {
      var value = _ref.value;

      var date = (0, _moment2.default)({ month: value.month });
      var output = '';
      if (date.isValid()) {
...
MonthInput.handledProps = ['closable', 'dateFormat', 'disable', 'initialDate', 'maxDate', 'minDate', 'value'];
